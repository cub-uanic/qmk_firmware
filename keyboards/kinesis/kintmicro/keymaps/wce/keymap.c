...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT( // Layer 0 : default, actual on Mac with WCE layout (optimized for Java)
/*
                        ESC  !    @    #    {    }                      [    ]    *    (    )    =+
...
*/
  ...
  [_UNCONV] = LAYOUT( // Layer1: unconvenient keys on right hand, actual on Mac (optimized for Java / IntelliJ IDEA)
/*
...
*/
  ...
  [_FKEYS] = LAYOUT( // Layer2: F-keys + PgUp/PgDn on right hand
  ...
  [_MOUSE] = LAYOUT( // Layer3: mouse and navigation
  ...
  [_MACRO] = LAYOUT( // Layer5: Macros, media and full F-keys
